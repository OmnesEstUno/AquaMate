...
function promptFor(file) {
  return [
    ...
    '       - Live only: colorful, healthy, LIVE specimen showing how it looks in the hobby. STRONGLY reject',
    '         preserved/pressed/dead specimens, museum/herbarium sheets, scientific plates, and line drawings.',
    '         Use one ONLY as an absolute last resort when NO live photo of the species exists at all (caveat',
    '         note; if it is the sole survivor it is still recommended — see STEP 7).',
