...
function promptFor(file) {
  return [
    ...
    '',
    'STEP 7 — Select the best up to 3. A NON-EMPTY result MUST have EXACTLY ONE recommended:true:',
    '     the single best SURVIVING candidate is always recommended:true — even if it is a caveated',
    '     illustration that survived only because nothing better exists. All other entries are recommended:false.',
    '     If zero candidates pass, the result is an empty list — never pad with bad images, and an empty',
    '     list has no recommended entry.',
    '',
