...
function promptFor(file) {
  return [
    ...
    '       - Clear subject: well-lit and well-framed. Not tiny/distant, not heavily obscured.',
    ...
    '         a group over a lone specimen — that better represents how it is kept and displayed.',
