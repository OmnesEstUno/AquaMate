...
// The species-page wave partition SVG (a fixed backdrop behind the page content).
// Same gentle-wave path + parallax as the site header, with correct ocean fills
// (the header's own first <use> has a malformed rgba and renders wrong).
