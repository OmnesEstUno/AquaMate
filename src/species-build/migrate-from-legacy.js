...
function makeVariantStub(taxon) {
  switch (taxon) {
    case 'fish':
      return { breedingDifficulty: null, breedingNotes: null, conspecificAggression: null, finNippy: null, reefSafe: null, escapeRisk: null, venomousSpines: null, protogynous: null };
    case 'crustacean':
